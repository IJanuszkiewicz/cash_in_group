        ...
        child: BlocBuilder<NewExpenseCubit, NewExpenseState>(
          builder: (context, state) => switch (state) {
            NewExpenseStateLoaded(
              newExpense: final newExpense,
              groupDetails: final groupDetails,
            ) =>
            ...
            NewExpenseStateError(error: final e) => Center(
                child: Text(e),
              )
          },
        ),
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: () async {
                            final errors =
                                await BlocProvider.of<NewExpenseCubit>(context)
                                    .addExpense(
                              titleController.text,
                              amountController.text,
                              BlocProvider.of<AuthCubit>(context).userUid,
                            );
                            if (errors.isEmpty) {
